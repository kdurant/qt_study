 ...
 * 激光器开光 0x55, 0xAA, 0x00, 0x0C, 0x01, 0x00, 0x00, 0x00, 0x0f, 0x33, 0xcc
 * @return
 */
bool LaserType8::open()
{
    QVector<quint8> command{0x55, 0xAA, 0x00, 0x0C, 0x01, 0x00, 0x00, 0x00, 0x00, 0x33, 0xcc};
    QByteArray      frame;
    for(int i = 0; i < command.length(); i++)
    {
        frame.append(command[i] & 0xff);
 ...
 * 激光器关光 0x55, 0xAA, 0x00, 0x0D, 0x01, 0x00, 0x00, 0x00, 0x00, 0x33, 0xcc
 * @return
 */
bool LaserType8::close()
{
    QVector<quint8> command{0x55, 0xAA, 0x00, 0x0D, 0x01, 0x00, 0x00, 0x00, 0x00, 0x33, 0xcc};
    QByteArray      frame;
    for(int i = 0; i < command.length(); i++)
    {
        frame.append(command[i] & 0xff);
